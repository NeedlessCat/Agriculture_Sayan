        ...
        <div>
          <form className="bg-white shadow-lg rounded-lg px-8 py-10">
            <div className="mb-6">
              ...
              <input
                className="w-full border border-gray-300 rounded-lg py-3 px-4 focus:outline-none focus:ring-2 focus:ring-green-500"
                id="name"
                type="text"
            ...
            <button
              type="submit"
              className="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
            >
              Send Message
            </button>
          </form>
